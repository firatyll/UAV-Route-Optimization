...
def main():
    ...
    ant_colony_best_solution ,ant_colony_best_cost = antColony(task_list,depot_list,initial_solution)
    ...
    plot_environment(depot_list, task_list, initial_solution, ant_colony_best_solution, calculateTime, title="Ant Colony Solution", best_cost=ant_colony_best_cost, initial_cost=initial_cost)
